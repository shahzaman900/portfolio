    ...
    <>
      <div className='flex gap-2 flex-col w-[40%] p-4 rounded-md border-2 border-dotted hover:bg-accent/50'>
        ...
        <div className='flex gap-4'>
          <p className='px-2 py-1 hover:bg-primary hover:text-white rounded-md text-sm border'>React js</p>
          <p className='px-2 py-1 hover:bg-primary hover:text-white rounded-md text-sm border'>Ruby & rails</p>
          <p className='px-2 py-1 hover:bg-primary hover:text-white rounded-md text-sm border'>Postgres</p>
        </div>
      </div>
    </>
  )
